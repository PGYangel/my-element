...
var MIN_TIME = Object(util["w" /* parseDate */])('00:00:00', 'HH:mm:ss');
var MAX_TIME = Object(util["w" /* parseDate */])('23:59:59', 'HH:mm:ss');

var time_rangevue_type_script_lang_js_minTimeOfDay = function minTimeOfDay(date) {
  return Object(util["q" /* modifyDate */])(MIN_TIME, date.getFullYear(), date.getMonth(), date.getDate());
};

var time_rangevue_type_script_lang_js_maxTimeOfDay = function maxTimeOfDay(date) {
  return Object(util["q" /* modifyDate */])(MAX_TIME, date.getFullYear(), date.getMonth(), date.getDate());
};
...
/* harmony default export */ var time_rangevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    handleMinChange: function handleMinChange(date) {
      this.minDate = Object(util["b" /* clearMilliseconds */])(date);
      this.handleChange();
    },
    handleMaxChange: function handleMaxChange(date) {
      this.maxDate = Object(util["b" /* clearMilliseconds */])(date);
      this.handleChange();
    },
    handleChange: function handleChange() {
    ...
    handleConfirm: function handleConfirm() {
      ...
      this.minDate = Object(util["p" /* limitTimeRange */])(this.minDate, minSelectableRange, this.format);
      this.maxDate = Object(util["p" /* limitTimeRange */])(this.maxDate, maxSelectableRange, this.format);
    ...
    isValidValue: function isValidValue(date) {
      return Array.isArray(date) && Object(util["B" /* timeWithinRange */])(this.minDate, this.$refs.minSpinner.selectableRange) && Object(util["B" /* timeWithinRange */])(this.maxDate, this.$refs.maxSpinner.selectableRange);
    },
    handleKeydown: function handleKeydown(event) {
      var keyCode = event.keyCode;
      var mapping = { 38: -1, 40: 1, 37: -1, 39: 1 };
